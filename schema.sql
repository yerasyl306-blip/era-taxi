...
CREATE TABLE IF NOT EXISTS quotes(id TEXT PRIMARY KEY,userId TEXT REFERENCES users(id),payload TEXT NOT NULL,expires INTEGER NOT NULL);
CREATE TABLE IF NOT EXISTS waiting(orderId TEXT PRIMARY KEY REFERENCES orders(id),started INTEGER NOT NULL,ended INTEGER,fee INTEGER NOT NULL DEFAULT 0);
